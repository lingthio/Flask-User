...
class UserManager__Settings(object):
    ...
    USER_REQUEST_PASSWORD_RESET_URL = '/user/forgot-password' #:
    USER_REQUEST_EMAIL_CONFIRMATION_EMAIL_URL = '/user/resend-confirm-email' #:
    ...
    USER_FORGOT_PASSWORD_TEMPLATE = 'flask_user/request_password_reset.html' #:
    ...
    USER_RESEND_CONFIRM_EMAIL_TEMPLATE = 'flask_user/request_email_confirmation.html' #:
    USER_RESET_PASSWORD_TEMPLATE = 'flask_user/reset_password.html' #: .. note:: email template file settings and their defaults

    USER_CONFIRM_EMAIL_EMAIL_TEMPLATE = 'flask_user/email_templates/confirm_email' #:
